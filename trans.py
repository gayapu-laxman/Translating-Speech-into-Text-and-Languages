...
target_language_input = input("Enter the target language (e.g., 'Telugu,te', 'english,en'): ").strip()

# Check if the target language is valid (supports both name and code)
if target_language_input in language_map.values():  # If input is a valid code
    target_language_code = target_language_input
elif target_language_input in language_map.keys():  # If input is a valid name
